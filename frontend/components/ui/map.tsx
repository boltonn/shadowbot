...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  useEffect(() => {
    ...
    // so a referenced pattern/icon can 404 briefly. Feed back a transparent
    // pixel instead of letting it spam the console every frame it's needed.
    const styleImageMissingHandler = (e: { id: string }) => {
...
function MapMarker({
  ...
  // Wire up listeners once on mount; callbacksRef keeps them current.
  useEffect(() => {
