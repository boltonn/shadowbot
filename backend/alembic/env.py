...
config.set_main_option(
    "sqlalchemy.url",
    f"postgresql+asyncpg://{_settings.postgres.username}:{_settings.postgres.password}"
    f"@{_settings.postgres.host}:{_settings.postgres.port}/{_settings.postgres.database}",
)
